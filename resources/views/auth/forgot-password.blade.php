...
<head>
    ...
    <title>Lupa Password - Otoadly</title>
...
<body class="bg-navy-950 min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-300 text-sm mt-2">Reset password kamu</p>
        </div>
        ...
        <div class="bg-navy-800 rounded-2xl border border-white/10 p-8">
            ...
            @if (session('status'))
                <div class="bg-green-500/20 text-green-400 px-4 py-3 rounded-lg text-sm mb-6">
                    {{ session('status') }}
                </div>
            @endif
